...
export let mockShipments: WithId<Shipment>[] = [
    ...
    },
    {
      ...
      },
      {
        ...
        currentStatusId: 'pending',
        creationDate: new Date(),
        shipToParty: 'Lucknow Retail',
        shipToGstin: '09KLMNO1234P1Z2',
        unloadingPoint: 'Lucknow Warehouse',
        loadingPoint: 'Ghaziabad',
        consignor: 'SIKKA INDUSTRIES AND LOGISTICS',
        consignorGstin: '09AYQPS6936B1ZV',
        billToParty: 'Lucknow Retail',
        billToGstin: '09KLMNO1234P1Z2',
        invoiceNumber: 'SI0925081298',
        items: [
            { invoiceNumber: 'SI0925081298', itemDescription: 'TS CLASSIC', units: 3, weight: 0.018 },
            { invoiceNumber: 'SI0925081298, SI0925081315, SI0925081318', itemDescription: 'TATA SAMPANN', units: 83, weight: 0.570 },
            { invoiceNumber: 'SI0925081298', itemDescription: 'SPICESPURES HING 100X50G', units: 2, weight: 0.015 },
            { invoiceNumber: 'SI0925081298', itemDescription: 'SF MASALA', units: 1, weight: 0.015 },
            { invoiceNumber: 'SI0925081298', itemDescription: 'TATA SAMPN', units: 12, weight: 0.330 },
            { invoiceNumber: 'SI0925081298, SI0925081315', itemDescription: 'TOOR DAL', units: 23, weight: 1.341 },
            { invoiceNumber: 'SI0925081298', itemDescription: 'CHILLI POWDER', units: 26, weight: 0.126 },
            { invoiceNumber: 'SI0925081298', itemDescription: 'TURMERIC POWDER', units: 14, weight: 0.198 },
        ]
      }
];
