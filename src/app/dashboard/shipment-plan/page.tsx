...
import { collection, query, doc, getDoc, updateDoc, serverTimestamp, deleteDoc, runTransaction, addDoc } from "firebase/firestore";
...
export default function ShipmentPlanPage() {
  ...
  // Real-time listener for shipments across all authorized plants
  ...
  const handleCancelOrder = async (id: string) => {
    ...
    try {
        ...
        // Transactions errors handled by the runner
    } finally {
        hideLoader();
    }
  };
