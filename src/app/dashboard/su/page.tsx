...
const ALL_TCODES = [
  ...
  { code: 'XD01', desc: 'Customer Create' }, { code: 'XD02', desc: 'Customer Change' }, { code: 'XD03', desc: 'Customer Display' }, { code: 'VA01', desc: 'Sales Order Create' }, { code: 'VA02', desc: 'Sales Order Change' }, { code: 'VA03', desc: 'Sales Order Display' }, { code: 'VA04', desc: 'Short Close' },
  // Vehicle Management T-Codes
  { code: 'VT01', desc: 'Vehicle Create' },
  { code: 'VT02', desc: 'Vehicle Edit/Delete' },
  { code: 'VT03', desc: 'Vehicle Display' },
  { code: 'VT_ENTRY', desc: 'Tab: Vehicle Entry' },
  { code: 'VT_STATUS', desc: 'Tab: Vehicle Status' },
  { code: 'VT_EXIT', desc: 'Tab: Vehicle Exit' },
  { code: 'VT_UPDATE_STATUS', desc: 'Func: Update Status' },
  { code: 'VT_LOAD_CN', desc: 'Func: Load Vehicle/CN' },
