        ...
        <div className="flex-1 flex flex-col overflow-hidden bg-[#f0f3f9]">
          <div className="flex-1 overflow-y-auto p-2 md:p-4 relative print:p-0 print:overflow-visible">
            {activeScreen === 'HOME' ? (
              ...
              <div className={cn("bg-white shadow-xl rounded-sm border border-slate-300 overflow-hidden animate-slide-up h-[calc(100vh-145px)] p-4 md:p-6 mx-auto print:p-0 print:border-none print:shadow-none flex flex-col", hideSidebar ? "w-full" : "w-full max-w-[1400px]")}>
          ...
          return (
            <div key={s.label} className="flex flex-col items-center gap-4 group">
              ...
              <div className="text-center space-y-1">
                ...
                {i <= activeStep && (
                  <p className="text-[14px] text-blue-600 font-bold uppercase whitespace-nowrap">
