      ...
      <div className="flex-1 flex overflow-hidden">
        <div className="w-80 bg-white border-r border-slate-300 flex flex-col shadow-lg z-10">
          <div className="p-4 bg-slate-50 border-b border-slate-200">
             <span className="text-[10px] font-black text-blue-600 bg-blue-50 px-2 py-0.5">{gpsData.length} ACTIVE SATELLITE NODES</span>
          </div>
          <div className="flex-1 overflow-y-auto green-scrollbar">
            {gpsData.map((v: any, i: number) => (
              <div key={i} className="p-4 border-b border-slate-100 hover:bg-blue-50 cursor-pointer transition-all">
