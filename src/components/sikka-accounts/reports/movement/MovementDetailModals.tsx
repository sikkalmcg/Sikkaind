                                        ...
                                        <TableRow key={idx} className="h-16 border-b border-slate-50 last:border-0 hover:bg-blue-50/20 transition-colors">
                                            {isOutward ? (
                                                <>
                                                    ...
                                                    <TableCell className="px-4 text-center text-xs font-bold text-slate-500">{formatSafeDate(item.invoiceDate, 'dd/MM/yyyy')}</TableCell>
                                                ...
                                                <>
                                                    ...
                                                    <TableCell className="px-4 text-center text-xs font-bold text-slate-500">{formatSafeDate(item.paymentDate, 'dd/MM/yyyy')}</TableCell>
                    ...
                    {migoDrillDown && (
                        <div className="p-10 space-y-10">
                            <div className="grid grid-cols-2 gap-y-8 gap-x-12 p-8 bg-slate-50 rounded-[2rem] border border-slate-200 relative overflow-hidden">
                                ...
                                {[
                                    { label: 'Receipt Date', value: formatSafeDate(migoDrillDown.paymentDate, 'dd/MM/yyyy HH:mm:ss') },
