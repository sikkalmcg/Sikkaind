          ...
          <DialogContent className="max-w-[85vw] w-[1400px] h-[90vh] flex flex-col p-0 border-none shadow-3xl bg-white rounded-3xl">
            {loading ? (
                <div className="flex flex-col items-center justify-center h-full gap-4">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400">Syncing LR Manifest Registry...</p>
                </div>
            ) : (
                <>
