        ...
        <div id="printable-area" className="A4-page flex flex-col h-full bg-white text-black font-sans text-[9.5pt] leading-tight flex flex-col relative box-border h-[297mm] w-[210mm] overflow-hidden select-text border-none mx-auto">
            ...
            <div className="flex justify-between items-start border-b-4 border-black pb-6 mb-8 shrink-0">
                <div className="space-y-1.5 flex-1 pr-10">
                    ...
                    <div className="text-[8pt] font-black mt-3 flex flex-wrap gap-x-5 gap-y-2 uppercase leading-snug">
                        <p className="flex items-center gap-2"><span className="text-slate-500 font-bold uppercase text-[7.5pt]">PHONE:</span> <span className="text-slate-900 font-mono font-black">{carrier.mobile || carrier.phone || '--'}</span></p>
                        <p className="flex items-center gap-2"><span className="text-slate-500 font-bold uppercase text-[7.5pt]">GSTIN:</span> <span className="font-mono text-slate-950 font-black text-[13pt] tracking-tighter">{carrier.gstin || '--'}</span></p>
            ...
            <div className="mt-auto pt-8 border-t-2 border-slate-100 grid grid-cols-2 gap-12 shrink-0">
                <div className="space-y-4">
                    <span className="text-[9pt] font-bold uppercase text-slate-900 border-b border-black inline-block pb-0.5 tracking-widest italic">TERMS & CONDITIONS</span>
