...
export default function PrintableLR({ lr, copyType, pageNumber, totalInSeries }: PrintableLRProps) {
  ...
  // Registry Logic: Grouping and Summarization
  ...
  // Mission Rule: Summarization threshold (3 or more distinct items)
      ...
      <div className="flex justify-between items-start mb-6 shrink-0">
        ...
        <div className="min-w-[240px] space-y-3">
          ...
          <div className="text-[9pt] font-black uppercase space-y-1.5 px-2">
            ...
            <p className="flex justify-between gap-6"><span>FROM:</span> <span className="text-slate-900">{lr.from?.split(',')[0].toUpperCase() || 'GHAZIABAD'}</span></p>
            <p className="flex justify-between gap-6"><span>TO:</span> <span className="text-slate-900">{lr.to?.split(',')[0].toUpperCase() || 'N/A'}</span></p>
          </div>
        </div>
      </div>
            ...
            <div key={idx} className="border-2 border-black rounded-[1.5rem] p-4 pt-6 relative min-h-[120px] flex flex-col justify-center bg-white shadow-md text-center">
                ...
                <div className="space-y-1 mt-1">
                    ...
                    <div className="flex flex-col gap-0.5 pt-1.5 border-t border-slate-100 mt-1.5">
                        <p className="font-black text-slate-900 text-[7.5pt]">GSTIN: <span className="font-mono uppercase">{node.gstin || 'N/A'}</span></p>
                    </div>
                </div>
            </div>
        ))}
        ...
        <div className="border-2 border-black rounded-[1.5rem] overflow-hidden flex flex-col shadow-lg bg-white">
            ...
            <tbody className="text-[9pt]">
                ...
                <tr key={idx} className="align-middle border-b-2 border-slate-100 last:border-b-0">
                    ...
                    <td className="px-4 text-center font-black text-[12pt] text-slate-900 tracking-tighter">
            ...
            <tfoot className="bg-[#1a1d24] font-black h-12 border-t-2 border-black text-[10pt] text-white">
                ...
                <td className="text-center px-4 font-black text-slate-400 tracking-tighter text-[13pt]">
