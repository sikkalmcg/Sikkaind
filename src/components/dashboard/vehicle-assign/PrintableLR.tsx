  ...
  return (
    <div className="A4-page p-[8mm] bg-white text-black font-sans text-[9pt] leading-tight flex flex-col relative select-text box-border h-[297mm] overflow-hidden">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="border-2 border-black rounded-[1.5rem] p-4 relative min-h-[120px] flex flex-col justify-center">
          <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-black text-white px-3 py-1 rounded-full text-[7.5pt] font-black uppercase tracking-widest shadow-lg whitespace-nowrap text-center">CONSIGNOR (SENDER)</div>
          <div className="space-y-1 text-center mt-1">
            <p className="text-[9pt] font-black uppercase text-slate-900 leading-tight">{lr.consignorName}</p>
            <p className="text-[7.5pt] font-bold text-slate-600 leading-snug italic uppercase">{lr.consignorAddress || lr.from}</p>
            <p className="font-black text-slate-900 text-[7.5pt] pt-1">GSTIN: <span className="font-mono uppercase">{lr.consignorGtin || '--'}</span></p>
          </div>
        </div>
        <div className="border-2 border-black rounded-[1.5rem] p-4 relative min-h-[120px] flex flex-col justify-center">
          <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-black text-white px-3 py-1 rounded-full text-[7.5pt] font-black uppercase tracking-widest shadow-lg whitespace-nowrap text-center">CONSIGNEE (RECEIVER)</div>
          <div className="space-y-1 text-center mt-1">
            <p className="text-[9pt] font-black uppercase text-slate-900 leading-tight">{lr.buyerName || lr.shipToParty || '--'}</p>
            <p className="text-[7.5pt] font-bold text-slate-600 leading-snug italic uppercase">{buyerAddress || '--'}</p>
            <p className="font-black text-slate-900 text-[7.5pt] pt-1">GSTIN: <span className="font-mono uppercase">{lr.buyerGtin || '--'}</span></p>
          </div>
        </div>
        <div className="border-2 border-black rounded-[1.5rem] p-4 relative min-h-[120px] flex flex-col justify-center">
          <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-black text-white px-3 py-1 rounded-full text-[7.5pt] font-black uppercase tracking-widest shadow-lg whitespace-nowrap text-center">SHIP TO PARTY</div>
          <div className="space-y-1 text-center mt-1">
            <p className="text-[9pt] font-black uppercase text-blue-900 leading-tight">{lr.shipToParty || lr.buyerName}</p>
            <p className="text-[7.5pt] font-bold text-slate-600 leading-snug italic uppercase">{shipToAddress || '--'}</p>
            <p className="font-black text-slate-900 text-[7.5pt] pt-1">GSTIN: <span className="font-mono uppercase">{lr.shipToGtin || '--'}</span></p>
          </div>
        </div>
      </div>
