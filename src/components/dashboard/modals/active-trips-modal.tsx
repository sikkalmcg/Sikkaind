...
import { ShieldCheck, Search, Radar, MapPin, Loader2, PlayCircle } from "lucide-react";
      ...
      <DialogContent className="max-w-[95vw] w-full h-[90vh] flex flex-col p-0 border-none shadow-3xl overflow-hidden bg-white rounded-3xl">
        <DialogHeader className="p-6 bg-slate-900 text-white shrink-0">
          <DialogTitle className="text-xl font-black uppercase tracking-tight italic flex items-center gap-3">
            <PlayCircle className="h-6 w-6 text-blue-400" /> Active Missions Manifest
          </DialogTitle>
          <DialogDescription className="text-blue-300 font-bold uppercase text-[9px] tracking-widest mt-1">
            Plant: {plantName} | Consolidated Operational Monitor
          </DialogDescription>
        </DialogHeader>
            ...
            <ScrollArea className="h-full">
                ...
                <div className="rounded-3xl border-2 border-slate-200 bg-white shadow-xl overflow-hidden">
                    ...
                    <TableHeader className="sticky top-0 bg-slate-100 z-10 border-b-2">
                        ...
                        <TableHead className="text-[10px] font-black uppercase px-4 text-center text-slate-500 w-40">Status Node</TableHead>
                    ...
                    <TableBody>
                        ...
                        <TableRow><TableCell colSpan={9} className="h-64 text-center text-slate-400 italic font-medium uppercase tracking-widest opacity-40">No active mission records found.</TableCell></TableRow>
                        ) : (
        ...
        <DialogFooter className="p-6 bg-slate-50 border-t flex-row items-center justify-between sm:justify-between shrink-0">
            <div className="flex items-center gap-4">
                ...
                <span className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Aggregate Mission Registry Pulse Synchronized</span>
            </div>
