...
function VehicleInForm({ upcomingVehicleData }: VehicleInProps) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      lrDate: upcomingVehicleData?.lrDate ? (upcomingVehicleData.lrDate instanceof Date ? upcomingVehicleData.lrDate : (upcomingVehicleData.lrDate as any).toDate()) : null,
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
        ...
        // Registry Integrity: Do NOT change trip status to 'Available' here. 
        // Trip must remain 'Assigned' so it appears on the Supervisor board until task completion.
