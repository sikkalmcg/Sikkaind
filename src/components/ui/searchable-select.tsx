 ...
 * High-fidelity combobox for efficient node identification.
 */
export function SearchableSelect({
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-[var(--radix-popover-trigger-width)] p-0 border-slate-200 shadow-2xl rounded-2xl overflow-hidden" align="start">
              ...
              {filteredOptions.map((option) => (
                ...
                >
                  <span className={cn(
                    ...
                    value === option.value ? "text-white" : "group-hover:text-blue-900"
                  )}>
                    {option.label}
                  </span>
                  {value === option.value && (
